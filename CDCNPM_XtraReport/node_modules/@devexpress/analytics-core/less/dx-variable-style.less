.dx-designer-viewport {
    ...
    /* Icons -------------------------*/
    .dxd-icon-accented .dxd-icon-fill, .dxd-icon-highlighted:hover .dxd-icon-fill {
        fill: @color9;
    }
    ...
    .dxd-state-active, .dxd-back-contrast .dxd-back-highlighted:hover, .dx-menu-item.dx-state-focused {
        .dxd-icon-fill {
            fill: @color1;
        }
    }
