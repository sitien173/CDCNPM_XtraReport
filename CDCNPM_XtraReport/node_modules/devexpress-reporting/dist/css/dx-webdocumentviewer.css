...
.dxrd-preview.dxrd-designer-wrapper .dxrd-preview-parameters-wrapper .dxrd-right-panel-content.dxrd-parameters-bottom-border {
...
.dx-report-viewer.dx-accessibility .dx-popup-content .dx-filtereditor-search .dx-texteditor:not(.dx-multiline):not(.dx-textarea) .dx-texteditor-input{
  font-size:0.875rem;
}
.dx-report-viewer.dx-accessibility .dx-popup-content .dx-filtereditor-search .dx-texteditor:not(.dx-multiline):not(.dx-textarea) .dx-placeholder{
  font-size:0.875rem;
...
.dx-report-viewer.dx-accessibility .dxrd-preview.dxrd-designer-wrapper .dxrd-preview-parameters-wrapper .dxrd-right-panel-content.dxrd-parameters-bottom-border{
  border-bottom-width:0.0625rem;
  padding-bottom:0.3125rem;
}
