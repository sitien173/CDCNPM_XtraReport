...
.dx-designer .dxrd-error-panel .dxrd-error-panel-content .dx-toolbar .dx-button .dx-button-content {
  padding-top: 6px;
}
.dx-designer .dxrd-error-panel .dxrd-error-panel-content .dx-toolbar .dxrd-collect-errors-button {
  padding-left: 15px;
}
.dx-designer .dxrd-error-panel .dxrd-error-panel-content .dx-toolbar .dx-buttongroup-wrapper .dx-button-has-text .dx-button-content {
  padding-top: 3px;
}
...
.dxrd-expressioneditor-popup-content .dx-expression-tree .dx-expressioneditor-textarea {
  height: 257px;
}
.dxrd-expressioneditor-popup-content .dx-expression-tree .dx-expressioneditor-tools {
  height: 230px;
}
.dxrd-expressioneditor-popup-content .dx-expression-tree .dx-expressioneditor-tools .dx-expressioneditor-tools-tabs {
  top: 19px;
}
